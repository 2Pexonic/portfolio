...
export const projects: Project[] = [
  {
    ...
    solution: "A redesigned mobile application that simplifies the printing journey, improves usability, and creates a scalable digital printing platform with a consistent visual identity.",
  ...
  },
  {
    ...
    problem: "Many founders and innovators struggle to find the right teammates. Existing platforms focus either on hiring or networking, but lack dedicated tools for startup team formation and project collaboration.",
